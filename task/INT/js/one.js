data= [{"id":1,"first_name":"Gregg","last_name":"Lacey","job":"Web Developer III","salary":"$3.62","location":"Malta"},
...
// // const findDev=()=>{
// // const response=data.filter(item=>item.job==='Web Developer III'
// // || item.job==='Web Developer II');
// // return response;
...
// //  const salaryToNum=()=>{
// //     const response= data.map((item)=>Number(item.salary.replace('$','')));
...
// //         const response = Number(item.salary.replace('$',''));
// //         const correctedSalary = response*10000;
// //         item.corrected_salary = correctedSalary;
// //         return item;
// //     });
// //     return result;
// // }
...
// // const sum=()=>{
// //     const salary=data.map((item)=>Number(item.salary.replace('$','')));
// //     const res = salary.reduce((acc,cur)=>acc+cur,0);
// //     return res;
...
// //         const salary = Number(cur.salary.replace('$',''))
// //         const country = cur.location;
...
//         const salary = Number(curr.salary.replace('$',''));
//         const country = curr.location;
...
//         let answer={};
//         for(let country in sum){
//             answer[country] = sum[country]/count[country];
//         }
//         return answer;
// }
...
const average=()=>{
    ...
    let result={};
    for(const country in sum){
    result[country] = sum[country]/count[country];
