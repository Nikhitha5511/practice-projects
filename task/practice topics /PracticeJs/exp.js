const items=[{"id":1,"first_name":"Gregg","last_name":"Lacey","job":"Web Developer III","salary":"$3.62","location":"Malta"},
...
// const result =()=>{
//     const data = items.filter(item=>item.job==='Web Developer III'||item.job=== 'Web Developer II');
//     return data;
// }
...
//         item.salary=Number(item.salary.replace('$',""));
//         return item;;
//     })
...
// const updatedResult =()=>{
//     return items.map((item)=>{
//         const salaryValue = Number(item.salary.replace('$',''));
//         const correctedSalary = Math.round(salaryValue*10000);
...
//         const result = Number(curr.salary.replace('$',''));
//         return acc+result;
//     },0);
// }
...
// const sumOfSalariesByCountries=()=>{
//     return items.reduce((acc,item)=>{
//     const salary = Number(item.salary.replace('$',''));
//     if(!acc[item.location]){
//         acc[item.location]=0;
//     }
//     acc[item.location] +=salary;
//     return acc;
//     },{})
// }

// console.log(sumOfSalariesByCountries());
